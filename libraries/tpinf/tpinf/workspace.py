...
def create_makefile(dirname):
    ...
    with open(subject_dir/ 'makefile', 'w') as makefile:
        ...
        makefile.write('\t@echo\n')
        makefile.write('\t@echo\n')
        makefile.write('\t@echo "Your name:\\033[1;32m" `cat .name.cfg` "\\033[0m"\n')
        makefile.write('\t@echo "---------"\n')
        makefile.write('\t@echo\n')
        makefile.write('\t@echo\n')
        ...
        makefile.write('\t@echo "with \\033[1;32mno return key\\033[0m and then you press the <tab> key,"\n')
        ...
        makefile.write('\t@echo "------------------------------"\n')
        makefile.write('\t@echo\n')
        makefile.write('\t@echo "\\033[1;32mmake sign             \\033[0m <- Tell us your name."\n')
        makefile.write('\t@echo "\\033[1;32mmake instructions     \\033[0m <- displays the instructions."\n')
        makefile.write('\t@echo "\\033[1;32mmake oops             \\033[0m <- \\033[0;31mcall this if you delete a file accidentally.\\033[0m"\n')
        makefile.write('\t@echo\n')
        makefile.write('\t@echo "------------------------------"\n')
        makefile.write('\t@echo\n')
        for part, questions in toc.items():
            for question in questions:
                makefile.write('\t@echo "\\033[1;32mmake question{}-part{}  \\033[0m <- compiles and executes question {} of part {}."\n'.format(question, part, question, part))
            makefile.write('\t@echo\n')
        makefile.write('\t@echo "------------------------------"\n')
        makefile.write('\t@echo\n')
        ...
        makefile.write('\t@echo "Follow the following steps (type \\033[1;32mmake oops\\033[0m in order to view"\n')
        makefile.write('\t@echo "this message  again):"\n')
        makefile.write('\t@echo "- Step 1 : \\033[1;32mmake show-history\\033[0m            <-- identify the commit \\033[1;32mid\\033[0m of the commit where"\n')
        makefile.write('\t@echo "                                            your file is (the first code of a line)"\n')
        makefile.write('\t@echo "- Step 2 : \\033[1;32mmake recover ID=... FILE=...\\033[0m <-- Tell the commit \\033[1;32mid\\033[0m and the file name and you"\n')
        makefile.write('\t@echo "                                            will get it back."\n')
        makefile.write('\t@echo "      e.g. \\033[1;32mmake recover ID=34b9dfd FILE=part1.hpp\\033[0m"\n')
